...
export default function FeedPage() {
    ...
    return (
        <div className="bg-gradient-to-br from-white to-gray-50/50 border border-gray-100 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 p-6 mb-6">
            <div className="container mx-auto px-4 py-6 max-w-4xl">
                ...
                <div className="bg-gradient-to-br from-white to-gray-50/50 border border-gray-100 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 p-6 mb-6">
                    ...
                    <div className="flex justify-end mt-2 gap-2">
                        ...
                        className={`
                            flex items-center gap-2 px-6 py-2.5 rounded-xl font-medium text-sm transition-all duration-200 transform
                            ${
