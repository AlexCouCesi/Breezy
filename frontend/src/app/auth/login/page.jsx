...
export default function LoginPage() {
    ...
    useEffect(() => {
        ...
        .catch(() => {
            console.log('Pas de session active, reste sur la page de login');
        });
    }, [router]);
    ...
    return (
        ...
        <div className="w-1/2 bg-neutral-300 flex items-center justify-center px-4">
            ...
            <FormGroup label="Courriel">
                <Input type="email" placeholder="Votre courriel" value={email} onChange={e => setEmail(e.target.value)} />
            </FormGroup>
            ...
            <Button onClick={handleLogin} className="mt-6 w-full">Se connecter</Button>
